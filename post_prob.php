...
<body>
    <div class="container">
        <div class="login-head py-3">
            <span class="fs-2">問題</span>
        </div>
        <div class="login-main">
            <form class="needs-validation" action="handle/handlePostProb.php" method="post" enctype="multipart/form-data">
                ...
                <input class="btn btn-primary" type="submit" name="postProb">
            </form>
        </div>
